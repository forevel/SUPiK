...
void sys_settingsdialog::paintEvent(QPaintEvent *event)
{
    ...
    painter.drawPixmap(rect(), QPixmap(":/pic/Pic/SysWallpaper.png"));
...
//    resize(384, 374);
    ...
    qssdIcon.addFile(QString::fromUtf8(":/pic/Pic/supik.png"), QSize(), QIcon::Normal, QIcon::Off);
...
//    CancelPB->setStyleSheet("color: rgb(185, 0, 0);");
    ...
    RusIcon.addFile(":/pic/Pic/LangRU.png", QSize(), QIcon::Normal, QIcon::Off);
    LangCB->addItem(RusIcon, "RU");
    EngIcon.addFile(":/pic/Pic/langGB.png", QSize(), QIcon::Normal, QIcon::Off);
