...
CREATE TABLE `cables` (
  `idcables` int(11) NOT NULL,
  `PartNumber` varchar(45) DEFAULT NULL,
  `Manufacturer` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idcables`)
...
--
-- Table structure for table `fasteners`
--
...
CREATE TABLE `fasteners` (
  `idfasteners` int(11) NOT NULL,
  `PartNumber` varchar(45) DEFAULT NULL,
  `Manufacturer` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idfasteners`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `fasteners`
--

LOCK TABLES `fasteners` WRITE;
/*!40000 ALTER TABLE `fasteners` DISABLE KEYS */;
/*!40000 ALTER TABLE `fasteners` ENABLE KEYS */;
UNLOCK TABLES;
