...
void cmp_compdialog::paintEvent(QPaintEvent *event)
{
    ...
    painter.drawPixmap(rect(), QPixmap(":/pic/Pic/CompWallpaper.jpg"));
...
"background-color: rgb(200, 255, 196);"));
    ...
    QIcon icon1;
    icon1.addFile(QStringLiteral(":/pic/Pic/icon_zap.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"background-color: rgb(220, 220, 220);"));
    QIcon icon2;
    icon2.addFile(QStringLiteral(":/pic/Pic/cross.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    QIcon icon3;
    icon3.addFile(QStringLiteral(":/pic/Pic/Deldocy.png"), QSize(), QIcon::Normal, QIcon::Off);
...
bool cmp_compdialog::ConnectPartNumber()
{
    ...
    return (static_cast<bool>(handle1) & static_cast<bool>(handle2) \
            & static_cast<bool>(handle3) & static_cast<bool>(handle4) \
            & static_cast<bool>(handle5) & static_cast<bool>(handle6) & static_cast<bool>(handle7));
}
