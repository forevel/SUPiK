...
#define FW_PIXTE    22 // поле вывода текста с изображением
#define FW_COUNT    23 // количество типов полей
...
#define FD_TEXTEDIT 9 // поле текстового ввода в несколько строк
...
//    QString Date; // Сегодняшняя дата
    ...
    int idGroup; // ИД группы пользователя, определяет права пользователя в системе (sup.groups.idgroup)
