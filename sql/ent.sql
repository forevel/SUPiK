...
INSERT INTO `parameters` VALUES (3,'Конденсаторы','Ёмкость','Ном. напряжение','','','','10','1','','','',0,'2001','20/08/2015 21:22:08'),(4,'Разъемы','Количество контактов','Рабочий ток','Напряжение изоляции','','','30','17','1','','',0,'2001','20/08/2015 21:22:08'),(5,'Диоды','Падение напряжения','Рабочий ток','Скорость переключения','Обр. напряжение','','1','17','32','1','',0,'2001','20/08/2015 21:22:08'),(6,'Управление питанием','Входное напряжение','Выходное напряжение','Рабочий ток','Рабочая частота','Падение напряжения','1','1','17','32','1',0,'2001','20/08/2015 21:22:08'),(8,'Изоляторы','Напряжение изоляции','Напряжение питания','Кол-во каналов на стороне 1','Кол-во каналов на стороне 2','Максимальная скорость','1','1','30','30','32',0,'2001','20/08/2015 21:22:08'),(9,'Оптоэлектроника','Цвет свечения','Падение напряжения','Количество в корпусе','','','39','1','30','','',0,'2001','20/08/2015 21:22:08'),(10,'Источники питания','Входное напряжение','Выходное напряжение','Выходной ток','КПД','Частота переключения','1','1','17','','32',0,'2001','20/08/2015 21:22:08'),(11,'Резисторы','Сопротивление','Напряжение изоляции','','','','9','1','','','',0,'2001','20/08/2015 21:22:08'),(12,'Транзисторы','Рабочий ток','Обр. напряжение','Коэфф. усиления','Скорость переключения','Тип','17','1','','32','',0,'2001','20/08/2015 21:22:08'),(7,'Источники опорного напряжения','Входное напряжение','Выходное напряжение','Выходной ток','','','1','1','17','','',0,'2001','20/08/2015 21:22:08'),(16,'Устройства коммутации','Количество в корпусе','Рабочий ток','Напряжение изоляции','','','30','17','1','','',0,'2001','20/08/2015 21:22:08'),(17,'Модули','Тип','',NULL,NULL,NULL,'0',NULL,NULL,NULL,NULL,0,NULL,NULL),(20,'Варисторы','Ном. напряжение RMS','Ном. напряжение DC','Энергия','Ток (8/20)','','1','1','60','17','',0,'2001','20/08/2015 21:22:08'),(21,'Защитные диоды','Ном. напряжение','Напряжение пробоя','Ток (10/1000)','','','1','1','17','','',0,'2001','20/08/2015 21:22:08'),(22,'Ключи аналоговые','Кол-во каналов','Проходное сопротивление','Рабочее напряжение','Скорость переключения','Тип','30','9','1','32','',0,'2001','20/08/2015 21:22:08'),(23,'Оптроны','Падение напряжения','Макс. обр. напряжение','Скорость переключения','Коэффициент передачи по току','Тип','1','1','32','98','',0,'2001','20/08/2015 21:22:08'),(24,'Интерфейсы','Скорость передачи','Тип','Количество каналов','','','63','','30','','',0,'2001','20/08/2015 21:22:08'),(15,'Операционные усилители','Рабочее напряжение','Скорость нарастания','Коэфф. усиления','Напряжение смещения','КОСС','1','56','','1','',0,'2001','20/08/2015 21:22:08'),(13,'Защита','Кол-во каналов','Ном. напряжение','Применение','','','30','1','','','',0,'2001','20/08/2015 21:22:08'),(25,'Индуктивности','Индуктивность','Рабочий ток','Добротность','Сопротивление','','69','17','','9','',0,'2001','20/08/2015 21:22:08'),(26,'Микроконтроллеры','Тактовая частота','Архитектура','ОЗУ','ПЗУ','Напряжение питания','32','','','','',0,'2001','20/08/2015 21:22:08'),(27,'Память','Ёмкость','Ном. напряжение','Скорость записи','Скорость чтения','Тип','74','1','63','63','',0,'2001','20/08/2015 21:22:08'),(28,'Генераторы','Частота','Тип','Ёмкость нагрузки','Напряжение питания','','32','','10','1','',0,'2001','20/08/2015 21:22:08'),(30,'Позисторы','Рабочий ток','Сопр. в открытом состоянии','Время срабатывания','Рабочее напряжение','','17','9','50','1','',0,'2001','20/08/2015 21:22:08'),(29,'Разрядники','Ном. напряжение','Напряжение горения дуги','Время срабатывания','','','1','1','50','','',0,'2001','20/08/2015 21:22:08'),(35,'Аналоговые (разное)','Описание','Ном. напряжение','Параметр 3','Параметр 4','Параметр 5','','1','','','',0,'2001','20/08/2015 21:22:08'),(36,'АЦП и ЦАП','Разрешение (бит)','Скорость оцифровки','Опорное напряжение','Количество каналов','Тип цифрового выхода','','32','1','30','',0,'2001','20/08/2015 21:22:08'),(37,'Трансформаторы','Коэффициент трансформации','Максимальный первичный ток/напряжение','Сопротивление обмотки','Точность по амплитуде','Точность по углу','','89','9','98','98',0,'2001','20/08/2015 21:22:08'),(38,'Изоляторы','Напряжение изоляции','Напряжение питания','Кол-во каналов на стороне 1','Кол-во каналов на стороне 2','Максимальная скорость','0',NULL,NULL,NULL,NULL,0,NULL,NULL);
