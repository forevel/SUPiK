...
//    void AddColumn(QString db, QString tble, QString col, QString def = "NULL"); // добавить поле col в таблицу tble БД db со значением по умолчанию def
    ...
    QList<QStringList> SearchInTableLike (const QString &db, const QString &tble, QStringList &fields, const QString &cmpfield, const QString &cmpvalue); // вернуть список из записей, для которых field похож на regexpstr
