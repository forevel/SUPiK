...
void sys_backuprestoredirdialog::paintEvent(QPaintEvent *event)
{
    ...
    painter.drawPixmap(rect(), QPixmap(":/pic/Pic/Sys2Wallpaper.png"));
...
void sys_backuprestoredirdialog::SetupUI()
{
    ...
    s_tqTableView *mainTV = new s_tqTableView(true);
    ...
    ImpExpPB->setIcon(QIcon((isImport)?":/pic/Pic/import.png":":/pic/Pic/export.png"));
